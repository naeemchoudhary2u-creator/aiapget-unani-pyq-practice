...
export interface _SERVICE {
  ...
  'activateSubscriptionFromPayment' : ActorMethod<
    [string, string, string],
    boolean
  >,
  'addQuestion' : ActorMethod<[Question], boolean>,
  'approvePayment' : ActorMethod<[string, string], boolean>,
  'approveSubscription' : ActorMethod<[string, string, string], boolean>,
  'assignCallerUserRole' : ActorMethod<[Principal, UserRole], undefined>,
  'calcExpiryDatePublic' : ActorMethod<[string, bigint], string>,
  ...
  'rejectSubscription' : ActorMethod<[string, string], boolean>,
